...
bld_i = db.load('/gpfs/exfel/theory_group/user/berberic/MTIP/reciprocal_proj_data/3d_pentagon_10p_spher_mO99_inverse_no_psd_arc.h5')
bld_p = db.load('/gpfs/exfel/theory_group/user/berberic/MTIP/reciprocal_proj_data/3d_pentagon_10p_spher_mO99_pseudo_no_psd_arc.h5')
bld_1 = db.load('/gpfs/exfel/theory_group/user/berberic/MTIP/reciprocal_proj_data/3d_model_0_mO99_cn_not_binned_pseudo_no_psd.h5')
