...
settings_ana = load_settings('fxs2510','bg_162',target='analysis')
...
opt = {'data_grid' : data_grid, 'q_limits': [None,None],'radial_bin_size_in_pixels':1}
